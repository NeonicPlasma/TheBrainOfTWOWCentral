...
class EVENT:
	...
	def start(self, SERVER): # Set the parameters
		...
		self.param["MESSAGES"] = discord.utils.get(SERVER["MAIN"].channels, name="staff-chat") # Take messages from here
		self.param["LOGGING"] = discord.utils.get(SERVER["MAIN"].channels, name="staff-chat") # Log eliminations here
